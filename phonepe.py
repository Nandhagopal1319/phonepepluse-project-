...
def state_list():
    nandha = psycopg2.connect(
        host='localhost', user='postgres', password='Nandha@1997', database='phonepe')
...
class data_load:
    ...
    def sql_table_creation():
        nandha = psycopg2.connect(host='localhost', user='postgres', password='Nandha@1997', database='phonepe')
        cursor = nandha.cursor()
...
class state:
    ...
    def original_state_list():
        nandha = psycopg2.connect(host='localhost', user='postgres',
                                password='Nandha@1997', database='phonepe')
        cursor =  nandha.cursor()
